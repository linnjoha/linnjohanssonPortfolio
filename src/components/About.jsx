      ...
      <div className="about-wrapper">
        <div className="about-header">
          ...
          <motion.p className="about-text">
            ...
            React, Node.js together with database and cloud development. <br />
            If you don't find me nerding by the computer you'll find me spending
            time with my family, gardening or chasing a good workout outside.
          </motion.p>
          <Socials />
        </div>
        <motion.div
